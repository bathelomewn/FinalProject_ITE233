...
{
    public partial class CamperSelectActivities : Form
    {
        public CamperSelectActivities()
        {
            InitializeComponent();
        }

        private void CamperSelectActivities_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sub4.Items.Clear();
                sub5.Items.Clear();
                sub1.Items.Add("Swimming");
                sub2.Items.Add("Swimming");
                sub3.Items.Add("Swimming");
                sub4.Items.Add("Swimming");
                sub5.Items.Add("Swimming");
            }
        }
