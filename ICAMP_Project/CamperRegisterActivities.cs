...
{
    public partial class CamperRegisterActivities : Form
    {
        public CamperRegisterActivities()
        {
            InitializeComponent();
        }

        private void CamperRegisterActivities_Load(object sender, EventArgs e)
        {
            LoadXml();
        }
        ...
        private void del1_btn_Click(object sender, EventArgs e)
        {
